...
UE.I18N['en'] = {
  ...
  attachment: {
    static: {
      ...
      lang_start_upload: 'Start upload',
      lang_drop_remind:
        'You can drop files here, a single maximum of 300 files',
    },
    uploadSelectFile: 'Select File',
    uploadAddFile: 'Add File',
    uploadStart: 'Start Upload',
  ...
  insertvideo: {
    ...
    flashLoadingError:
      'The Flash failed loading! Please check the path or network state',
  ...
  webapp: {
    tip1:
      'This function provided by Baidu APP,please apply for baidu APPKey webmaster first!',
    tip2: 'And then open the file neditor.config.js to set it! ',
    applyFor: 'APPLY FOR',
    anthorApi: 'Baidu API',
  },
  template: {
  ...
  music: {
    static: {
      lang_input_tips:
        'Input singer/song/album, search you interested in music!',
      J_searchBtn: { value: 'Search songs' },
    },
    emptyTxt:
      'Not search to the relevant music results, please change a keyword try.',
    chapter: 'Songs',
    singer: 'Singer',
    special: 'Album',
    listenTest: 'Audition',
  ...
  link: {
    ...
    httpPrompt:
      'The hyperlink you enter should start with "http|https|ftp://"!',
  },
  map: {
    static: {
      lang_city: 'City',
