 ...
 * neditor parse
 * version: 2.1.20
 * build: Mon Nov 23 2020 18:01:59 GMT+0800 (GMT+08:00)
 */ !(function () {
  !(function () {
    UE = window.UE || {}
    var a = !!window.ActiveXObject,
      b = {
        ...
        off: function (a, c, d) {
          ...
          if (f)
            for (; f--; )
              if (((c = e[f]), a.removeEventListener))
                ...
                if (d._d && d._d[g]) {
                  ...
                  i != -1 && d._d.els.splice(i, 1),
                    0 == d._d.els.length && delete d._d[g]
                }
              }
        },
        loadFile: (function () {
          ...
          return function (c, d, e) {
            ...
            if (
              (b.push({ doc: c, url: d.src || d.href, funs: [e] }), !c.body)
            ) {
              var g = []
            ...
            if (!d.id || !c.getElementById(d.id)) {
              ...
              ;(i.onload = i.onreadystatechange = function () {
                ...
                (i.onerror = function () {
                  throw Error(
                    'The load ' + (d.href || d.src) + ' fails,check the url'
                  )
                }),
      ...
      (uParse = function (a, c) {
        b.domReady(function () {
          ...
          if (document.querySelectorAll) d = document.querySelectorAll(a)
            ...
            d = [document.getElementById(a.replace(/^#/, ''))]
          else if (/^\./.test(a)) {
            var d = []
            b.each(document.getElementsByTagName('*'), function (b) {
              b.className &&
                new RegExp('\\b' + a.replace(/^\./, '') + '\\b', 'i').test(
                  b.className
                ) &&
                d.push(b)
            })
    ...
    UE.parse.register('table', function (a) {
      ...
      function c(b, c, e) {
        ...
        for (
          var m = b.ownerDocument.createDocumentFragment(), n = 0, k = g.length;
          n < k;
          n++
        )
          m.appendChild(g[n])
        ...
        i
          ? o.insertBefore(
              m,
              f[i - range.endRowIndex + range.beginRowIndex - 1]
            )
          : o.appendChild(m)
      }
      function d(a, b) {
      ...
      function e(b) {
        if (!a.hasClass(b.rows[0], 'firstRow')) {
          for (var c = 1; c < b.rows.length; c++)
            a.removeClass(b.rows[c], 'firstRow')
    ...
    UE.parse.register('charts', function (a) {
      ...
      function c(a) {
        for (
          var b, c = [], e = a.getElementsByTagName('table'), f = 0;
          (b = e[f]);
          f++
        )
      ...
      function d(a) {
        for (
          var b, c = a.getAttribute('data-chart'), d = {}, e = [], f = 0;
          (b = a.rows[f]);
          f++
        ) {
      ...
      function i() {
        for (var a = null, b = null, c = null, d = 0, e = o.length; d < e; d++)
          (a = o[d]),
            (b = l(a)),
            (c = k(a.table)),
            j(c, typeConfig[a.meta.chartType], b)
      }
      function j(a, b, c) {
        $(a).highcharts(
          $.extend({}, b, {
      ...
      function k(a) {
        ...
        return (
          (b.className = 'edui-chart-container'),
      ...
      function l(a) {
        ...
        if ('1' != f.dataFormat) {
          for (var g = 0, h = e.length; g < h; g++)
            for (var i = 0, j = e[g].length; i < j; i++)
              d[i] || (d[i] = []), (d[i][g] = e[g][i])
          e = d
        }
        if (((d = {}), f.chartType != typeConfig.length - 1)) {
          c = e[0].slice(1)
          for (var k, g = 1; (k = e[g]); g++)
            b.push({ name: k[0], data: k.slice(1) })
          ;(d.series = b),
            (d.categories = c),
            (d.title = f.title),
          ...
          for (var k = [], g = 1, h = e[0].length; g < h; g++)
            k.push([e[0][g], 0 | e[1][g]])
    ...
    UE.parse.register('background', function (a) {
      for (
        var b, c, d = this, e = d.root, f = e.getElementsByTagName('p'), g = 0;
        (c = f[g++]);

      )
        (b = c.getAttribute('data-background')),
          b && c.parentNode.removeChild(c)
    ...
    UE.parse.register('list', function (a) {
          ...
          if (b.className && /custom_/i.test(b.className)) {
            ...
            switch (f) {
              case 'cn':
                a.pushItem(
                  c,
                  h + ' li.list-' + f + '-paddingleft-1{padding-left:25px}'
                ),
                  a.pushItem(
                    c,
                    h + ' li.list-' + f + '-paddingleft-2{padding-left:40px}'
                  ),
                  a.pushItem(
                    c,
                    h + ' li.list-' + f + '-paddingleft-3{padding-left:55px}'
                  )
                break
              case 'cn1':
                a.pushItem(
                  c,
                  h + ' li.list-' + f + '-paddingleft-1{padding-left:30px}'
                ),
                  a.pushItem(
                    c,
                    h + ' li.list-' + f + '-paddingleft-2{padding-left:40px}'
              ...
              case 'cn2':
                a.pushItem(
                  c,
                  h + ' li.list-' + f + '-paddingleft-1{padding-left:40px}'
                ),
                  a.pushItem(
                    c,
                    h + ' li.list-' + f + '-paddingleft-2{padding-left:55px}'
                  ),
                  a.pushItem(
                    c,
                    h + ' li.list-' + f + '-paddingleft-3{padding-left:68px}'
                  )
                break
              case 'num':
              case 'num1':
              ...
              case 'num2':
                a.pushItem(
                  c,
                  h + ' li.list-' + f + '-paddingleft-1{padding-left:35px}'
                ),
                  a.pushItem(
                    c,
                    h + ' li.list-' + f + '-paddingleft-2{padding-left:40px}'
              ...
              case 'dash':
                a.pushItem(
                  c,
                  h + ' li.list-' + f + '-paddingleft{padding-left:35px}'
                )
                break
              case 'dot':
                a.pushItem(
                  c,
                  h + ' li.list-' + f + '-paddingleft{padding-left:20px}'
                )
            }
          }
        })
      ...
      a.extend(
        this,
        {
          liiconpath: a.removeLastbs(this.rootPath) + '/themes/ueditor-list/',
