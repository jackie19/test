...
;(function () {
  ...
  function createPreviewVideo(url) {
    ...
    if (url.startsWith('<embed>')) {
      $G('preview').innerHTML =
        '<div class="previewMsg"><span>' + lang.urlError + '</span></div>' + url
    }
  }
  ...
  function insertUpload() {
    var videoObjs = [],
      ...
      videoSrcField =
        editor.getOpt('videoUploadService')(this, editor).videoSrcField ||
        'url',
      videoSrc = '',
      ...
      uploader.on('all', function (type, files) {
        switch (type) {
          ...
          case 'startUpload':
            /* 设置Uploader配置项 */
            editor
              .getOpt('videoUploadService')(_this, editor)
