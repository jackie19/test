  ...
  UploadImage.prototype = {
    ...
    initUploader: function () {
      ...
      uploader.on('all', function (type, files) {
        switch (type) {
          ...
          case 'startUpload':
            /* 设置Uploader配置项 */
            editor
              .getOpt('imageUploadService')(_this, editor)
              .setUploaderOptions(uploader)
      ...
      uploader.on('uploadBeforeSend', function (object, data, headers) {
        ...
        editor
          .getOpt('imageUploadService')(_this, editor)
          .setFormData(object, data, headers)
      })
    ...
    getInsertList: function () {
      var i,
        ...
        imageSrcField =
          editor.getOpt('imageUploadService')(this, editor).imageSrcField ||
          'url',
        imageSrc = '',
    ...
    getImageData: function () {
      var _this = this,
        ...
        url =
          ...
          '&cl=2' +
          type +
          '&ie=utf-8&oe=utf-8&adpicid=&z=&ic=0&word=' +
          key +
          '&se=&tab=&width=&height=&istype=2&qc=&nc=1&fr=&pn=60&rn=' +
          pageNum +
          '&gsm=78&' +
          new Date() +
          '='
