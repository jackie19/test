        ...
        d.extend(c.prototype, {
          ...
          option: function (a, b) {
            ...
            return arguments.length > 1
              ? void (d.isPlainObject(b) && d.isPlainObject(c[a])
                  ? d.extend(c[a], b)
                  : (c[a] = b))
              : a
              ? c[a]
    ...
    b('lib/file', ['base', 'lib/blob'], function (a, b) {
      function c(a, c) {
        ...
        b.apply(this, arguments),
          ...
          !f &&
            this.type &&
            ((f = /\/(jpg|jpeg|png|gif|bmp)$/i.exec(this.type)
              ? RegExp.$1.toLowerCase()
              : ''),
            (this.name += '.' + f)),
          !this.type &&
            ~'jpg,jpeg,png,gif,bmp'.indexOf(f) &&
            (this.type = 'image/' + ('jpg' === f ? 'jpeg' : f)),
          (this.ext = f),
        ...
        return b.register(
          ...
          },
          {
              ...
              return (
                ...
                b.owner.trigger('beforeFileQueued', a)
                  ? b.acceptFile(a)
                    ...
                    : void b.owner.trigger('error', 'Q_TYPE_DENIED', a)
                  : void 0
              )
            },
            getFile: function (a) {
            ...
            retry: function (a, b) {
              ...
              for (
                c = f.queue.getFiles(i.ERROR), d = 0, e = c.length;
                e > d;
                d++
              )
            ...
            },
            {
                ...
                f.each(b.request('get-files', h.INVALID), function () {
                  ...
                  b.runing ||
                    ...
                    f.each(b.pool, function (a, c) {
                      var d = c.file
                      d.getStatus() === h.INTERRUPT &&
                        (d.setStatus(h.PROGRESS),
                        (b._trigged = !1),
              ...
              _nextBlock: function () {
                ...
                return d && d.has() && d.file.getStatus() === h.PROGRESS
                  ...
                  : c.runing
                  ? (!c.pending.length &&
                      c.getStats().numOfQueue &&
                      c._prepareNextFile(),
                    (a = c.pending.shift()),
                    (b = function (a) {
                      return a
                        ? ((d = e(a, f.chunked ? f.chunkSize : 0)),
                          (c._act = d),
                          d.fetch())
                        : null
                    }),
              ...
              a.on('beforeFileQueued', function (a) {
                return a.size > d
                  ? (a.setStatus(c.Status.INVALID, 'exceed_size'),
                    this.trigger('error', 'F_EXCEED_SIZE', a),
                    !1)
                  : void 0
              })
          }),
        ...
        return b.register('DragAndDrop', {
          ...
          _getTansferFiles: function (b, c) {
            ...
            for (
              ...
              (g = e[i]),
                (h = d && d[i]),
                k && h.webkitGetAsEntry().isDirectory
                  ? m.push(this._traverseDirectoryTree(h.webkitGetAsEntry(), l))
                  : l.push(g)
    ...
    b('runtime/html5/jpegencoder', [], function () {
      function a(a) {
        ...
        function j(a, b) {
          ...
          var _
          for (k = 0; n > k; ++k)
            (_ = a[k] * b[k]), (F[k] = _ > 0 ? (_ + 0.5) | 0 : (_ - 0.5) | 0)
          return F
        }
        function k() {
          i(65504),
          ...
          getAsBlob: function (a) {
            ...
            if (((a = a || this.type), this.modified || this.type !== a)) {
              if (((b = this._canvas), 'image/jpeg' === a)) {
                if (
                  ((d = c.canvasToDataUrl(b, 'image/jpeg', e.quality)),
            ...
            return (
              ...
              b.on('load', function () {
                ...
                return (
                  ...
                  (a._xhr = null),
                  c >= 200 && 300 > c
                    ? ((a._response = b.exec('getResponse')),
                      (a._responseJson = b.exec('getResponseAsJson')))
                    : c >= 500 && 600 > c
                    ? ((a._response = b.exec('getResponse')),
                      (a._responseJson = b.exec('getResponseAsJson')),
                      (d = 'server'))
