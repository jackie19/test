...
;(function () {
    ...
    htmlUpdateTransform: function () {
      ...
      if (elem.tagName === 'SPAN') {
        ...
        if (currentTextTransform !== wrapper.cTT) {
          ...
          xCorr +=
            sintheta * baseline * (quad ? 1 - alignCorrection : alignCorrection)
          yCorr -=
            costheta *
            baseline *
      ...
      if (gridLineWidth) {
        ...
        if (gridLine === UNDEFINED) {
          ...
          tick.gridLine = gridLine = gridLineWidth
            ? renderer.path(gridLinePath).attr(attribs).add(axis.gridGroup)
            : null
        }
  ...
  Tooltip.prototype = {
    ...
    refresh: function (point, mouseEvent) {
      ...
      if (text === false) {
        ...
        borderColor =
          options.borderColor || point.color || currentSeries.color || '#606060'
        label.attr({
          stroke: borderColor,
        })
  ...
  var PiePoint = extendClass(Point, {
    ...
    setVisible: function (vis) {
      ...
      each(['graphic', 'dataLabel', 'connector', 'shadowGroup'], function (
        key
      ) {
        if (point[key]) {
          point[key][method]()
