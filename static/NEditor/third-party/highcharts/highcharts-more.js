...
;(function (j, C) {
  ...
  var G = N.prototype,
    ...
    O = {
      ...
      setAxisSize: function () {
        ...
        if (this.isRadial)
          (this.center = this.pane.center = h.pie.prototype.getCenter.call(
            this.pane
          )),
      ...
      getPosition: function (a, b) {
        ...
        return this.postTranslate(
          this.translate(a),
          r(b, this.center[2] / 2) - this.offset
        )
      },
        ...
        this.options.gridLineInterpolation === 'polygon'
          ...
          : (l || ((e[0] = this.translate(a)), (e[1] = this.translate(b))),
            ...
            (d = this.chart.renderer.symbols.arc(
              ...
              e[0],
              e[0],
              { start: a, end: b, innerR: r(e[1], e[0] - e[2]), open: n }
            )))
        return d
      },
  ...
  o(G, 'init', function (a, b, c) {
    ...
    if (!e && (d || g)) {
      ...
      if (!b.panes) b.panes = []
      this.pane =
        ((k = b.panes[l] = b.panes[l] || new J(M(n.pane)[l], b, this)), (l = k))
      l = l.options
      b.inverted = !1
      n.chart.zoomType = null
      this.startAngleRad = b = ((l.startAngle - 90) * Math.PI) / 180
      this.endAngleRad = n =
        ((r(l.endAngle, l.startAngle + 360) - 90) * Math.PI) / 180
  ...
  o(u, 'getLabelPosition', function (a, b, c, d, g, f, e, i, n) {
    var l = this.axis,
      ...
      h = f.align,
      j =
        (((l.translate(this.pos) + l.startAngleRad + Math.PI / 2) / Math.PI) *
          180) %
        360
    l.isRadial
      ? ((a = l.getPosition(this.pos, l.center[2] / 2 + r(f.distance, -25))),
        f.rotation === 'auto'
          ? d.attr({ rotation: j })
          : k === null &&
            (k = v(d.styles.lineHeight) * 0.9 - d.getBBox().height / 2),
        h === null &&
          ((h = l.isCircular
            ? j > 20 && j < 160
              ? 'left'
  ...
  o(u, 'getMarkPath', function (a, b, c, d, g, f, e) {
    var i = this.axis
    i.isRadial
      ? ((a = i.getPosition(this.pos, i.center[2] / 2 + d)),
        (b = ['M', b, c, 'L', a.x, a.y]))
  ...
  h.arearange = j.extendClass(h.area, {
    ...
    getSegmentPath: function (a) {
      ...
      for (
        ...
        (f = a[d]),
          f.plotHigh !== null && c.push({ plotX: f.plotX, plotY: f.plotHigh })
      a = g.call(this, b)
      if (i)
        i === !0 && (i = 'left'),
          (e.step = { left: 'right', center: 'center', right: 'left' }[i])
      c = g.call(this, c)
      e.step = i
      e = [].concat(a, c)
      c[0] = 'L'
  ...
  u = {
    ...
    translate: function () {
      ...
      s(this.points, function (d) {
        ...
        b.wrap === !1 &&
          (k = Math.max(a.startAngleRad, Math.min(a.endAngleRad, k)))
        k = (k * 180) / Math.PI
        d.shapeType = 'path'
        d.shapeArgs = {
          d: g.path || [
    ...
    translate: function () {
      ...
      for (d = 0, c = g.length; d < c; d++) {
        ...
        f.isSum || f.isIntermediateSum
          ? ((e.y = b.translate(k[1], 0, 1)),
            (e.height = b.translate(k[0], 0, 1) - e.y))
          : (l += i.total)
    ...
    this.tickPositions &&
      (s(this.series, function (b) {
        ...
        if (
          b.type === 'bubble' &&
          b.visible &&
          ((a.allowZoomOutside = !0), q.push(b), f)
        )
          s(['minSize', 'maxSize'], function (a) {
            ...
            b.length &&
              ((k = t.min(
                ...
                t.max(
                  P(b),
                  c.displayNegative === !1 ? c.zThreshold : -Number.MAX_VALUE
                )
              )),
              (m = t.max(m, Q(b))))
      }),
  ...
  o(q, 'alignDataLabel', function (a, b, c, d, g, f) {
    if (this.chart.polar) {
      ...
      if (d.verticalAlign === null)
        d.verticalAlign =
          a < 45 || a > 315 ? 'bottom' : a > 135 && a < 225 ? 'top' : 'middle'
    ...
    c.polar
      ? s(c.axes, function (a) {
          ...
          d[f ? 'xAxis' : 'yAxis'].push({
            ...
            value: a.translate(
              f
                ? Math.PI - Math.atan2(h, e)
                : Math.sqrt(Math.pow(h, 2) + Math.pow(e, 2)),
              !0
            ),
          })
        })
