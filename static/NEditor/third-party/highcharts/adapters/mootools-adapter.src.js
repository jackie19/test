  ...
  win.HighchartsAdapter = {
    ...
    init: function (pathAnim) {
      var fxProto = Fx.prototype,
        ...
        morphCompute =
          morphProto.compute /* allow unused parameters in fx functions */

      // override Fx.start to allow animation of SVG element wrappers
      /*jslint unparam: true*/ fxProto.start = function (from, to) {
        var fx = this,
          elem = fx.element
    ...
    animate: function (el, params, options) {
      ...
      if (isSVGElement && !el.setStyle) {
        ...
        el.setStyle = function () {
          // property value is given as array in Moo - break it down
          var args = arguments
    ...
    removeEvent: function (el, type, fn) {
      ...
      if (el.addEvent) {
        // If el doesn't have an addEvent method, there are no events to remove
        if (type) {
          if (type === 'unload') {
            // Moo self destructs before custom unload events
            type = 'beforeunload'
