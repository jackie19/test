    ...
    init: function (c) {
          ...
          (this.adapterRun = function (a, d) {
            ...
            if (b)
              return (
                (a.style.zoom = 1),
                a[b] -
                  2 * parseInt(HighchartsAdapter._getStyle(a, 'padding'), 10)
              )
          })
      if (!Array.prototype.forEach)
        this.each = function (a, d) {
          for (var b = 0, c = a.length; b < c; b++)
            if (d.call(a[b], a[b], b, a) === !1) return b
        }
      ...
      this.animate = function (a, d, b) {
        ...
        if (typeof b !== 'object' || b === null)
          (e = arguments),
            (b = { duration: e[2], easing: e[3], complete: e[4] })
