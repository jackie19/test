...
;(function (g) {
  ...
  t(r.prototype, 'getSeriesExtremes', function (a) {
    ...
    l(this.series, function (a, i) {
      if (a.useMapGeometry)
        (c = Math.min(c, a[b ? 'minX' : 'minY'])),
          (d = Math.max(d, a[b ? 'maxX' : 'maxY'])),
          (a.xData = e[i])
    })
    this.dataMin = c
    this.dataMax = d
  ...
  t(r.prototype, 'setAxisTranslation', function (a) {
    ...
    if (b.options.chart.type === 'map' && !d && e.transA !== void 0)
      (this.transA = e.transA = Math.min(this.transA, e.transA)),
        (a = (e.max - e.min) / (this.max - this.min)),
        (e = a > c ? this : e),
        (c = (e.max - e.min) * e.transA),
  ...
  t(y.prototype, 'render', function (a) {
    ...
    c.zoomOnMouseWheel &&
      g.addEvent(
        b.container,
        document.onmousewheel === void 0 ? 'DOMMouseScroll' : 'mousewheel',
        function (a) {
  ...
  v(z.prototype, {
    onContainerDblClick: function (a) {
      ...
      b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop) &&
        b.mapZoom(
          0.5,
          b.xAxis[0].toValue(a.chartX),
          b.yAxis[0].toValue(a.chartY)
        )
    },
  ...
  k.map = g.extendClass(k.scatter, {
    ...
    drawLegendSymbolGradient: function (a, b) {
      ...
      e = b.toText.getBBox()
      h
        ? ((a.offsetWidth = f.width + j.width + e.width + c * 2 + d),
          (a.itemY = i + d))
        : ((a.offsetWidth = Math.max(f.width, e.width) + c + j.width + d),
          (a.itemY = j.height + d),
          (a.itemX = c))
    },
    getBox: function (a) {
      ...
      l(a || this.options.data, function (a) {
        for (
          ...
          typeof i[h] === 'number' &&
            !isNaN(i[h]) &&
            (j
              ? ((g = Math.max(g, i[h])), (m = Math.min(m, i[h])))
              : ((k = Math.max(k, i[h])), (l = Math.min(l, i[h]))),
            (j = !j))
        a._maxX = g
        a._minX = m
        a._maxY = k
    ...
    translatePath: function (a) {
      ...
      for (e = a.length; e--; )
        typeof a[e] === 'number' &&
          ((a[e] = b
            ? Math.round(c.translate(a[e]))
            : Math.round(d.len - d.translate(a[e]))),
          (b = !b))
      return a
    },
    setData: function () {
  ...
  g.Map = function (a, b) {
    ...
    a = p(
      {
        chart: { type: 'map', panning: 'xy' },
        xAxis: c,
        yAxis: p(c, { reversed: !0 }),
      },
      a,
      { chart: { inverted: !1 } }
    )
