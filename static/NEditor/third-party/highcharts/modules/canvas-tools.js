...
function RGBColor(m) {
  ...
  this.getHelpXML = function () {
    for (var b = [], k = 0; k < d.length; k++)
      for (var c = d[k].example, j = 0; j < c.length; j++) b[b.length] = c[j]
...
;(function () {
  function m() {
    ...
    a.ajax = function (a) {
      var d
      return (d = window.XMLHttpRequest
        ? new XMLHttpRequest()
        : new ActiveXObject('Microsoft.XMLHTTP'))
        ? (d.open('GET', a, !1), d.send(null), d.responseText)
        : null
    }
    ...
    a.Property = function (c, d) {
      ...
      this.Definition = {
        ...
        getFillStyle: function (b) {
          ...
          return d != null && d.createGradient
            ? d.createGradient(a.ctx, b)
            : d != null && d.createPattern
            ? d.createPattern(a.ctx, b)
            : null
        },
      }
      this.Length = {
      ...
      this.Angle = {
        toRadians: function () {
          ...
          var a = b.value + ''
          return a.match(/deg$/)
            ? b.numValue() * (Math.PI / 180)
            : a.match(/grad$/)
            ? b.numValue() * (Math.PI / 200)
            : a.match(/rad$/)
            ? b.numValue()
            : b.numValue() * (Math.PI / 180)
        },
    ...
    a.Font = new (function () {
      ...
      this.Parse = function (d) {
        for (
          var b = {},
            d = a.trim(a.compressSpaces(d || '')).split(' '),
            k = !1,
            e = !1,
            f = !1,
            g = !1,
    ...
    a.ToNumberArray = function (c) {
      for (
        var c = a
            .trim(a.compressSpaces((c || '').replace(/,/g, ' ')))
            .split(' '),
          d = 0;
        d < c.length;
        d++
      ...
      this.addBezierCurve = function (b, a, d, c, k, l, o, n) {
        ...
        for (i = 0; i <= 1; i++)
          (b = function (b) {
            return (
              Math.pow(1 - b, 3) * q[i] +
              3 * Math.pow(1 - b, 2) * b * p[i] +
              3 * (1 - b) * Math.pow(b, 2) * t[i] +
              Math.pow(b, 3) * m[i]
            )
          }),
            ...
            d == 0
              ? a != 0 &&
                ...
                0 < a &&
                  a < 1 &&
                  (i == 0 && this.addX(b(a)), i == 1 && this.addY(b(a))))
              : ((c = Math.pow(a, 2) - 4 * c * d),
                c < 0 ||
                  ((k = (-a + Math.sqrt(c)) / (2 * d)),
                  0 < k &&
                    k < 1 &&
                    (i == 0 && this.addX(b(k)), i == 1 && this.addY(b(k))),
                  (a = (-a - Math.sqrt(c)) / (2 * d)),
                  0 < a &&
                    a < 1 &&
                    (i == 0 && this.addX(b(a)), i == 1 && this.addY(b(a)))))
    ...
    a.Transform = function (c) {
      ...
      for (
        var c = a.trim(a.compressSpaces(c)).split(/\s(?=[a-z])/), b = 0;
        b < c.length;
        b++
      ) {
        var k = c[b].split('(')[0],
    ...
    a.AspectRatio = function (c, d, b, k, e, f, g, j, h, l) {
      ...
      h.hasValue() && l.hasValue()
        ...
        : (o.match(/^xMid/) &&
            ((d == 'meet' && p == q) || (d == 'slice' && m == q)) &&
            c.translate(b / 2 - k / 2, 0),
          o.match(/YMid$/) &&
            ((d == 'meet' && p == n) || (d == 'slice' && m == n)) &&
            c.translate(0, e / 2 - f / 2),
          o.match(/^xMax/) &&
            ((d == 'meet' && p == q) || (d == 'slice' && m == q)) &&
            c.translate(b - k, 0),
          o.match(/YMax$/) &&
    ...
    a.Element.ElementBase = function (c) {
        ...
        if (
          ...
          if (this.attribute('mask').hasValue()) {
            ...
            this.style('filter').hasValue()
              ? ((a = this.style('filter').Definition.getDefinition()),
                a != null && a.apply(b, this))
      ...
      if (c != null && c.nodeType == 1) {
        ...
        for (d = 0; d < c.attributes.length; d++)
          (b = c.attributes[d]),
            (this.attributes[b.nodeName] = new a.Property(
              b.nodeName,
              b.nodeValue
            ))
        ...
        if (this.attribute('class').hasValue())
          for (
            var d = a.compressSpaces(this.attribute('class').value).split(' '),
              e = 0;
            e < d.length;
            e++
          ) {
        ...
        if (this.attribute('style').hasValue()) {
          ...
          for (d = 0; d < b.length; d++)
            a.trim(b[d]) != '' &&
              ...
              (k = a.trim(c[0])),
              (c = a.trim(c[1])),
              (this.styles[k] = new a.Property(k, c)))
        }
        this.attribute('id').hasValue() &&
          a.Definitions[this.attribute('id').value] == null &&
          (a.Definitions[this.attribute('id').value] = this)
      }
    }
        ...
        if (this.style('fill').Definition.isUrl()) {
          ...
          (b = this.style('fill')),
            this.style('fill-opacity').hasValue() &&
              (b = b.Color.addOpacity(this.style('fill-opacity').value)),
            (d.fillStyle = b.value == 'none' ? 'rgba(0,0,0,0)' : b.value)
        if (this.style('stroke').Definition.isUrl()) {
          if (
            ((b = this.style('stroke').Definition.getFillStyle(this)),
            b != null)
          )
            d.strokeStyle = b
          ...
          (b = this.style('stroke')),
            this.style('stroke-opacity').hasValue() &&
              (b = b.Color.addOpacity(this.style('stroke-opacity').value)),
        ...
        if (typeof d.font != 'undefined')
          d.font = a.Font.CreateFont(
            ...
            this.style('font-size').hasValue()
              ? this.style('font-size').Length.toPixels() + 'px'
              : '',
            this.style('font-family').value
          ).toString()
        this.attribute('transform').hasValue() &&
          new a.Transform(this.attribute('transform').value).apply(d)
        this.attribute('clip-path').hasValue() &&
          ((b = this.attribute('clip-path').Definition.getDefinition()),
          b != null && b.apply(d))
      ...
      this.renderChildren = function (d) {
        ...
        if (b != null) {
          ...
          if (this.style('marker-mid').Definition.isUrl())
            for (
              var c = this.style('marker-mid').Definition.getDefinition(),
                e = 1;
              e < b.length - 1;
              e++
            )
          ...
          this.style('marker-end').Definition.isUrl() &&
            ((c = this.style('marker-end').Definition.getDefinition()),
            c.render(d, b[b.length - 1][0], b[b.length - 1][1]))
        }
      }
      ...
      this.setContext = function (d) {
        ...
        if (
          ...
          this.attribute('refX').hasValue() &&
            ...
            (f = -this.attribute('refY').Length.toPixels('y')))
          d.beginPath()
          d.moveTo(e, f)
          d.lineTo(b, f)
          d.lineTo(b, c)
    ...
    a.Element.circle = function (c) {
      ...
      this.path = function (d) {
        ...
        d != null &&
          (d.beginPath(), d.arc(b, c, e, 0, Math.PI * 2, !0), d.closePath())
    ...
    a.Element.line = function (c) {
      ...
      this.path = function (d) {
        ...
        d != null &&
          (d.beginPath(), d.moveTo(b[0].x, b[0].y), d.lineTo(b[1].x, b[1].y))
    ...
    a.Element.polyline = function (c) {
      ...
      this.path = function (d) {
        ...
        d != null &&
          (d.beginPath(), d.moveTo(this.points[0].x, this.points[0].y))
    ...
    a.Element.polygon = function (c) {
      ...
      this.path = function (a) {
        ...
        a != null &&
          (a.lineTo(this.points[0].x, this.points[0].y), a.closePath())
        return b
      }
    }
    ...
    a.Element.path = function (c) {
      ...
      this.PathParser = new (function (d) {
        ...
        this.isCommandOrEnd = function () {
          return this.isEnd()
            ? !0
            : this.tokens[this.i + 1].match(/^[A-Za-z]$/) != null
        }
        ...
        this.getPoint = function () {
          return this.makeAbsolute(
            new a.Point(this.getScalar(), this.getScalar())
          )
        }
        ...
        this.getReflectedControlPoint = function () {
          return this.previousCommand.toLowerCase() != 'c' &&
        ...
        for (d != null && d.beginPath(); !b.isEnd(); )
          switch ((b.nextCommand(), b.command.toUpperCase())) {
            ...
            case 'H':
              for (; !b.isCommandOrEnd(); )
                (e = new a.Point(
                  (b.isRelativeCommand() ? b.current.x : 0) + b.getScalar(),
                  b.current.y
                )),
            ...
            case 'V':
              for (; !b.isCommandOrEnd(); )
                (e = new a.Point(
                  b.current.x,
                  (b.isRelativeCommand() ? b.current.y : 0) + b.getScalar()
                )),
                  b.addMarker(e, b.current),
                  (b.current = e),
                  c.addPoint(b.current.x, b.current.y),
            ...
            case 'A':
              for (; !b.isCommandOrEnd(); ) {
                var g = b.current,
                  ...
                  e = b.getAsCurrentPoint(),
                  n = new a.Point(
                    (Math.cos(f) * (g.x - e.x)) / 2 +
                      (Math.sin(f) * (g.y - e.y)) / 2,
                    (-Math.sin(f) * (g.x - e.x)) / 2 +
                      (Math.cos(f) * (g.y - e.y)) / 2
                  ),
                  q =
                    Math.pow(n.x, 2) / Math.pow(h, 2) +
                    Math.pow(n.y, 2) / Math.pow(l, 2)
                q > 1 && ((h *= Math.sqrt(q)), (l *= Math.sqrt(q)))
                o =
                  (o == j ? -1 : 1) *
                  Math.sqrt(
                    (Math.pow(h, 2) * Math.pow(l, 2) -
                      Math.pow(h, 2) * Math.pow(n.y, 2) -
                      Math.pow(l, 2) * Math.pow(n.x, 2)) /
                      (Math.pow(h, 2) * Math.pow(n.y, 2) +
                        Math.pow(l, 2) * Math.pow(n.x, 2))
                  )
                isNaN(o) && (o = 0)
                var p = new a.Point((o * h * n.y) / l, (o * -l * n.x) / h),
                  g = new a.Point(
                    (g.x + e.x) / 2 + Math.cos(f) * p.x - Math.sin(f) * p.y,
                    (g.y + e.y) / 2 + Math.sin(f) * p.x + Math.cos(f) * p.y
                  ),
                  m = function (b, a) {
                    return (
                      (b[0] * a[0] + b[1] * a[1]) /
                  ...
                  s = function (b, a) {
                    return (
                      (b[0] * a[1] < b[1] * a[0] ? -1 : 1) * Math.acos(m(b, a))
                    )
                  },
                ...
                j == 1 && n < 0 && (n += 2 * Math.PI)
                q = new a.Point(
                  g.x - h * Math.cos((o + n) / 2),
                  g.y - l * Math.sin((o + n) / 2)
                )
                b.addMarkerAngle(
                  q,
                  (o + n) / 2 + ((j == 0 ? 1 : -1) * Math.PI) / 2
                )
      ...
      this.getMarkers = function () {
        for (
          var a = this.PathParser.getMarkerPoints(),
            b = this.PathParser.getMarkerAngles(),
            c = [],
            e = 0;
          e < a.length;
          e++
    ...
    a.Element.pattern = function (c) {
      ...
      this.createPattern = function (d) {
        ...
        b.attributes.viewBox = new a.Property(
          'viewBox',
        ...
        b.attributes.width = new a.Property(
          'width',
          this.attribute('width').value
        )
        b.attributes.height = new a.Property(
          'height',
    ...
    a.Element.marker = function (c) {
      ...
      this.render = function (d, b, c) {
        ...
        this.attribute('markerUnits').valueOrDefault('strokeWidth') ==
          'strokeWidth' && d.scale(d.lineWidth, d.lineWidth)
        d.save()
        var e = new a.Element.svg()
        e.attributes.viewBox = new a.Property(
          'viewBox',
          this.attribute('viewBox').value
        )
        ...
        e.attributes.width = new a.Property(
          'width',
          this.attribute('markerWidth').value
        )
        e.attributes.height = new a.Property(
          'height',
          this.attribute('markerHeight').value
        )
        e.attributes.fill = new a.Property(
          'fill',
          this.attribute('fill').valueOrDefault('black')
        )
        e.attributes.stroke = new a.Property(
          'stroke',
        ...
        d.restore()
        this.attribute('markerUnits').valueOrDefault('strokeWidth') ==
          'strokeWidth' && d.scale(1 / d.lineWidth, 1 / d.lineWidth)
        this.attribute('orient').valueOrDefault('auto') == 'auto' &&
          d.rotate(-c)
        d.translate(-b.x, -b.y)
      }
    }
    ...
    a.Element.GradientBase = function (c) {
      ...
      this.createGradient = function (d, b) {
        ...
        if (this.attribute('gradientTransform').hasValue()) {
          ...
          g.attributes.transform = new a.Property(
            'transform',
        ...
        var c = b.getBoundingBox(),
          e =
            this.gradientUnits == 'objectBoundingBox'
              ? c.x() + c.width() * this.attribute('x1').numValue()
              : this.attribute('x1').Length.toPixels('x'),
          f =
            this.gradientUnits == 'objectBoundingBox'
              ? c.y() + c.height() * this.attribute('y1').numValue()
              : this.attribute('y1').Length.toPixels('y'),
          g =
            this.gradientUnits == 'objectBoundingBox'
              ? c.x() + c.width() * this.attribute('x2').numValue()
              : this.attribute('x2').Length.toPixels('x'),
          c =
            this.gradientUnits == 'objectBoundingBox'
              ? c.y() + c.height() * this.attribute('y2').numValue()
              : this.attribute('y2').Length.toPixels('y')
    ...
    a.Element.radialGradient = function (c) {
      ...
      this.getGradient = function (a, b) {
        var c = b.getBoundingBox(),
          e =
            this.gradientUnits == 'objectBoundingBox'
              ? c.x() + c.width() * this.attribute('cx').numValue()
              : this.attribute('cx').Length.toPixels('x'),
          f =
            this.gradientUnits == 'objectBoundingBox'
              ? c.y() + c.height() * this.attribute('cy').numValue()
        ...
        this.attribute('fx').hasValue() &&
          (g =
            this.gradientUnits == 'objectBoundingBox'
              ? c.x() + c.width() * this.attribute('fx').numValue()
              : this.attribute('fx').Length.toPixels('x'))
        this.attribute('fy').hasValue() &&
          (j =
            this.gradientUnits == 'objectBoundingBox'
              ? c.y() + c.height() * this.attribute('fy').numValue()
              : this.attribute('fy').Length.toPixels('y'))
        c =
          this.gradientUnits == 'objectBoundingBox'
            ? ((c.width() + c.height()) / 2) * this.attribute('r').numValue()
    ...
    a.Element.AnimateBase = function (c) {
      ...
      this.maxDuration =
        this.begin + this.attribute('dur').Time.toMilliseconds()
      this.getProperty = function () {
        var a = this.attribute('attributeType').value,
          b = this.attribute('attributeName').value
        return a == 'CSS'
          ? this.parent.style(b, !0)
          : this.parent.attribute(b, !0)
      }
      ...
      this.update = function (a) {
        ...
        if (this.duration > this.maxDuration)
          if (this.attribute('repeatCount').value == 'indefinite')
            ...
            return this.attribute('fill').valueOrDefault('remove') ==
              'remove' && !this.removed
              ? ((this.removed = !0),
    ...
    a.Element.font = function (c) {
      ...
      for (c = 0; c < this.children.length; c++) {
        ...
        if (d.type == 'font-face')
          (this.fontFace = d),
            d.style('font-family').hasValue() &&
              (a.Definitions[d.style('font-family').value] = this)
        else if (d.type == 'missing-glyph') this.missingGlyph = d
        else if (d.type == 'glyph')
          d.arabicForm != ''
            ? ((this.isArabic = this.isRTL = !0),
              typeof this.glyphs[d.unicode] == 'undefined' &&
                (this.glyphs[d.unicode] = []),
              (this.glyphs[d.unicode][d.arabicForm] = d))
            : (this.glyphs[d.unicode] = d)
      }
    }
    ...
    a.Element.text = function (c) {
      ...
      if (c != null) {
        ...
        for (var d = 0; d < c.childNodes.length; d++) {
          ...
          b.nodeType == 1
            ? this.addChild(b, !0)
            : b.nodeType == 3 && this.addChild(new a.Element.tspan(b), !1)
        }
      }
      this.baseSetContext = this.setContext
      ...
      this.renderChildren = function (b) {
        for (
          var a = this.style('text-anchor').valueOrDefault('start'),
            c = this.attribute('x').Length.toPixels('x'),
          ...
          h.attribute('x').hasValue()
            ? (h.x = h.attribute('x').Length.toPixels('x'))
            : (h.attribute('dx').hasValue() &&
                (c += h.attribute('dx').Length.toPixels('x')),
              (h.x = c))
          c = h.measureText(b)
          ...
          c = h.x + c
          h.attribute('y').hasValue()
            ? (h.y = h.attribute('y').Length.toPixels('y'))
            : (h.attribute('dy').hasValue() &&
                (d += h.attribute('dy').Length.toPixels('y')),
              (h.y = d))
          d = h.y
          h.render(b)
        }
    ...
    a.Element.TextElementBase = function (c) {
      ...
      this.getGlyph = function (a, b, c) {
        ...
        if (a.isArabic) {
          ...
          if (
            ...
            g = 'initial'
          typeof a.glyphs[e] != 'undefined' &&
            ((f = a.glyphs[e][g]),
            f == null && a.glyphs[e].type == 'glyph' && (f = a.glyphs[e]))
        } else f = a.glyphs[e]
      ...
      this.renderChildren = function (c) {
        ...
        if (b != null) {
          var k = this.parent
              .style('font-size')
              .numValueOrDefault(a.Font.Parse(a.ctx.font).fontSize),
            e = this.parent
              .style('font-style')
              .valueOrDefault(a.Font.Parse(a.ctx.font).fontStyle),
            f = this.getText()
          b.isRTL && (f = f.split('').reverse().join(''))
          for (
            var g = a.ToNumberArray(this.parent.attribute('dx').value), j = 0;
            j < f.length;
            j++
          ) {
          ...
          c.strokeStyle != '' &&
            c.strokeText(a.compressSpaces(this.getText()), this.x, this.y),
            c.fillStyle != '' &&
              c.fillText(a.compressSpaces(this.getText()), this.x, this.y)
      }
      ...
      this.measureText = function (c) {
        ...
        if (b != null) {
          ...
          for (
            var f = a.ToNumberArray(this.parent.attribute('dx').value), g = 0;
            g < e.length;
            g++
          ) {
    ...
    a.Element.a = function (c) {
      ...
      this.hasText = !0
      for (var d = 0; d < c.childNodes.length; d++)
        if (c.childNodes[d].nodeType != 3) this.hasText = !1
      ...
      this.renderChildren = function (b) {
        if (this.hasText) {
          ...
          a.Mouse.checkBoundingBox(
            this,
            new a.BoundingBox(
              this.x,
              this.y - c.Length.toPixels('y'),
              this.x + this.measureText(b),
              this.y
            )
          )
        } else
    ...
    a.Element.style = function (c) {
      ...
      for (
        var c =
            c.childNodes[0].nodeValue +
            (c.childNodes.length > 1 ? c.childNodes[1].nodeValue : ''),
          c = c.replace(
            /(\/\*([^*]|[\r\n]|(\*+([^*\/]|[\r\n])))*\*+\/)|(^[\s]*\/\/.*)/gm,
            ''
          ),
          ...
          for (
            ...
            if (f != '') {
              for (var g = {}, j = 0; j < b.length; j++) {
                ...
                l != null &&
                  h != null &&
                  (g[a.trim(l)] = new a.Property(a.trim(l), a.trim(h)))
              }
              a.Styles[f] = g
              if (f == '@font-face') {
    ...
    a.Element.use = function (c) {
      ...
      this.setContext = function (a) {
        ...
        this.attribute('x').hasValue() &&
          a.translate(this.attribute('x').Length.toPixels('x'), 0)
        this.attribute('y').hasValue() &&
          a.translate(0, this.attribute('y').Length.toPixels('y'))
      }
          ...
          for (var h = 0; h < f; h++)
            for (var l = a[j * f * 4 + h * 4 + 3] / 255, o = 0; o < 4; o++) {
              for (
                ...
                m == 0
                  ? (r = 255)
                  : ((r = Math.max(h - q, 0)), (r = a[j * f * 4 + r * 4 + o]))
                m = r * (m == 0 || o == 3 ? 1 : m)
                p == 0
                  ? (r = 255)
                  : ((r = Math.min(h + q, f - 1)),
    ...
    a.CreateElement = function (c) {
      var d = c.nodeName.replace(/^[^:]+:/, ''),
        ...
        b = null,
        b =
          typeof a.Element[d] != 'undefined'
            ? new a.Element[d](c)
            : new a.Element.MISSING(c)
      b.type = c.nodeName
      return b
    }
    a.load = function (c, d) {
    ...
    a.loadXmlDoc = function (c, d) {
      ...
      if (a.opts.ignoreMouse != !0)
        (c.canvas.onclick = function (c) {
          c = b(
            new a.Point(
              c != null ? c.clientX : event.clientX,
              c != null ? c.clientY : event.clientY
            )
          )
      ...
      var k = a.CreateElement(d.documentElement),
        ...
        f = function () {
          ...
          if (
            a.opts != null &&
            a.opts.scaleWidth != null &&
            a.opts.scaleHeight != null
          ) {
            var f = 1,
              g = 1
            k.attribute('width').hasValue() &&
              (f =
                k.attribute('width').Length.toPixels('x') / a.opts.scaleWidth)
            k.attribute('height').hasValue() &&
              (g =
                k.attribute('height').Length.toPixels('y') / a.opts.scaleHeight)
          ...
          e &&
            ((e = !1),
            a.opts != null &&
              typeof a.opts.renderCallback == 'function' &&
              a.opts.renderCallback())
        },
        g = !0
      ...
      a.intervalID = setInterval(function () {
        ...
        a.opts != null &&
          typeof a.opts.forceRedraw == 'function' &&
          a.opts.forceRedraw() == !0 &&
          (b = !0)
    ...
    a.Mouse = new (function () {
      ...
      this.checkPath = function (a, d) {
        for (var b = 0; b < this.events.length; b++) {
          var k = this.events[b]
          d.isPointInPath &&
            d.isPointInPath(k.x, k.y) &&
            (this.eventElements[b] = a)
        }
      }
  ...
  this.canvg = function (a, c, d) {
    if (a == null && c == null && d == null)
      for (
        var c = document.getElementsByTagName('svg'), b = 0;
        b < c.length;
        b++
      ) {
        a = c[b]
      ...
      (d = d || {}),
        ...
        (b.opts = d),
        (a = a.getContext('2d')),
        typeof c.documentElement != 'undefined'
          ? b.loadXmlDoc(a, c)
          : c.substr(0, 1) == '<'
          ? b.loadXml(a, c)
          : b.load(a, c)
  ...
  b(c.prototype, {
    ...
    setContainer: function (a, b, c) {
      ...
      this.canvas = f(
        'canvas',
        { width: k, height: m },
        { position: 'relative', left: g, top: d },
        a
      )
      ...
      this.hiddenSvg = a = f(
        'div',
        { width: k, height: m },
        { visibility: 'hidden', left: g, top: d },
        e
      )
