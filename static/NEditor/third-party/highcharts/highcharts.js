...
;(function () {
  ...
  function Eb(a, b, c, d) {
    ...
    if (u(b)) {
      j >= D[pb] &&
        (i.setMilliseconds(0),
        i.setSeconds(j >= D[Ya] ? 0 : k * P(i.getSeconds() / k)))
    ...
    init: function (a, b, c) {
      var b = b || '',
        ...
        j = function (a) {
          for (g = a.length; g--; )
            a[g] === 'M' &&
              a.splice(g + 1, 0, a[g + 1], a[g + 2], a[g + 1], a[g + 2])
        }
      e && (j(b), j(c))
      a.isArea &&
        ((h = b.splice(b.length - 6, 6)), (i = c.splice(c.length - 6, 6)))
    ...
    O.HighchartsAdapter =
      ...
      (a && {
        init: function (b) {
          ...
          a.each(['cur', '_default', 'width', 'height', 'opacity'], function (
            a,
            b
          ) {
            var e = d,
  ...
  var ra = function (a) {
    ...
    ;(function (a) {
      a && a.stops
        ...
        : (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/.exec(
            a
          ))
  ...
  wa.prototype = {
    ...
    crisp: function (a, b, c, d, e) {
      var f,
        ...
        i,
        a =
          a || this.strokeWidth || (this.attr && this.attr('stroke-width')) || 0
      i = (t(a) % 2) / 2
      h.x = P(b || this.x || 0) + i
      h.y = P(c || this.y || 0) + i
        ...
        ? ((d.ontouchstart = function (a) {
          ...
          (d.onclick = function (a) {
            ;(oa.indexOf('Android') === -1 ||
              Date.now() - (c.touchEventFired || 0) > 1100) &&
              b.call(d, a)
          }))
        : (d['on' + a] = b)
      return this
      ...
      if (!a) {
        ...
        if (b.isSVG) {
          ...
          if (ta && e && e.fontSize === '11px' && c.toPrecision(3) === '22.7')
            a.height = c = 14
          if (d)
            (a.width = N(c * ca(f)) + N(b * V(f))),
              (a.height = N(c * V(f)) + N(b * ca(f)))
        }
        this.bBox = a
      }
      return a
  ...
  Ha.prototype = {
    ...
    init: function (a, b, c, d) {
      ...
      if (hb && a.getBoundingClientRect)
        (this.subPixelFix = b = function () {
          ...
          K(a, {
            left: xa(h.left) - h.left + 'px',
            top: xa(h.top) - h.top + 'px',
          })
        }),
          b(),
          J(O, 'resize', b)
        ...
        n(m, function (e) {
          if (e !== '' || m.length === 1) {
            var p = {},
              ...
              s
            g.test(e) &&
              ((s = e.match(g)[1].replace(/(;| |^)color([ :])/, '$1fill$2')),
              v(n, 'style', s))
            h.test(e) &&
              !d &&
            ...
            if (
              ...
              for (
                ...
                delete a.bBox,
                  ...
                  e.length &&
                    n.appendChild(
                      y.createTextNode(e.join(' ').replace(/- /g, '-'))
                    )
          }
        })
      })
    ...
    setSize: function (a, b, c) {
      ...
      this.height = b
      for (
        this.boxWrapper[o(c, !0) ? 'animate' : 'attr']({ width: a, height: b });
        e--;
    ...
    symbol: function (a, b, c, d, e, f) {
      ...
      if (h)
        (g = this.path(h)),
          r(g, { symbolName: a, x: b, y: c, width: d, height: e }),
          f && r(g, f)
      else if (i.test(a))
        (k = function (a, b) {
          a.element &&
            ...
            a.alignByTranslate ||
              a.translate(t((d - b[0]) / 2), t((e - b[1]) / 2)))
        }),
          (j = a.match(i)[1]),
          (a = Pb[j]),
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
      function j() {
        ...
        a = o.element.style
        L =
          (Oa === void 0 || la === void 0 || q.styles.textAlign) && o.getBBox()
        ...
        if (ea(a))
          ...
          for (c in a)
            if (
              ((d = a[c]),
              (m = !1),
              (e = p[c] && p[c].call(this, d, c)),
              e !== !1 && d !== null)
            ) {
              e !== w && (d = e)
              if (
                j &&
                /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c)
              )
  ...
  Ma.prototype = {
    addLabel: function () {
      ...
      a.isDatetimeAxis &&
        m &&
        (l = b.dateTimeLabelFormats[m.higherRanks[g] || m.unitName])
      this.isFirst = j
      this.isLast = k
    ...
    getLabelSize: function () {
      var a = this.label,
        b = this.axis
      return a
        ? (this.labelBBox = a.getBBox())[b.horiz ? 'height' : 'width']
        : 0
    },
    getLabelSides: function () {
      var a = this.axis,
        ...
        a =
          b * { left: 0, center: 0.5, right: 1 }[a.labelAlign] -
          a.options.labels.x
      return [-a, b - a]
    },
        ...
        (i.xy = E = this.getLabelPosition(H, E, i, g, k, x, a, r)),
          ...
          (this.isLast && !this.isFirst && !o(e.showLastLabel, 1))
            ...
            : !C &&
              g &&
              k.overflow === 'justify' &&
              !this.handleOverflow(a, E) &&
              (v = !1),
          r && a % r && (v = !1),
          v && !isNaN(E.y)
            ? ((E.opacity = c),
              i[this.isNew ? 'attr' : 'animate'](E),
              (this.isNew = !1))
            : i.attr('y', -9999)
    },
    destroy: function () {
  ...
  vb.prototype = {
    render: function () {
      ...
      if (h) {
        if (
          ((q = b.getPlotLinePath(l, h)),
          (d = { stroke: A, 'stroke-width': h }),
          m)
        )
          d.dashstyle = m
      } else if (k) {
  ...
  db.prototype = {
    defaultOptions: {
      ...
      title: {
        align: 'middle',
        style: { color: '#4d759e', fontWeight: 'bold' },
      },
      type: 'linear',
    },
    defaultYAxisOptions: {
    ...
    init: function (a, b) {
      ...
      qa(this, a.axes) === -1 &&
        (a.axes.push(this), a[c ? 'xAxis' : 'yAxis'].push(this))
    ...
    update: function (a, b) {
      var c = this.chart,
        a = (c.options[this.xOrY + 'Axis'][this.options.index] = x(
          this.userOptions,
          a
        ))
      this.destroy(!0)
      ...
      n(a.series, function (c) {
        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            ...
            c = c.dataMin
            if (u(c) && u(e))
              (a.dataMin = I(o(a.dataMin, c), c)),
                (a.dataMax = s(o(a.dataMax, e), e))
            if (u(d))
    ...
    getPlotLinePath: function (a, b, c, d) {
      ...
      return m && !d
        ? null
        : e.renderer.crispLine(['M', c, h, 'L', i, j], b || 0)
    },
    ...
    getLinearTickPositions: function (a, b, c) {
      for (
        var d, b = ia(P(b / a) * a), c = ia(xa(c / a) * a), e = [];
        b <= c;
    ...
    getMinorTickPositions: function () {
      ...
      if (this.isLog) {
        ...
        (d = d.concat(Eb(Cb(c), this.min, this.max, a.startOfWeek))),
    ...
    setTickPositions: function (a) {
      ...
      h
        ...
        : ((b.min = o(b.userMin, d.min, b.dataMin)),
          (b.max = o(b.userMax, d.max, b.dataMax)))
      if (e)
      ...
      if (
        b.range &&
        ((b.userMin = b.min = s(b.min, b.max - b.range)),
        (b.userMax = b.max),
        a)
      )
        b.range = null
      ...
      if (
        ...
        if (
          ...
          !u(b.userMax) &&
          j &&
          (b.dataMax > 0 || !b.ignoreMaxPadding)
        )
          b.max += c * j
      }
      b.min === b.max || b.min === void 0 || b.max === void 0
        ...
        : ((b.tickInterval = o(
            l,
            ba ? 1 : ((b.max - b.min) * p) / s(b.len, p)
          )),
          !u(l) &&
            b.len < p &&
            !this.isRadial &&
            ((q = !0), (b.tickInterval /= 4)))
      g &&
        !a &&
      ...
      b.minorTickInterval =
        d.minorTickInterval === 'auto' && b.tickInterval
          ? b.tickInterval / 5
          : d.minorTickInterval
      ...
      if (!a)
        !b.ordinalPositions &&
          (b.max - b.min) / b.tickInterval > s(2 * b.len, 200) &&
          ka(19, !0),
          (a = f
        ...
        if (!a.axisTitle)
          (a.axisTitle = c
            ...
            .attr({
              ...
              align:
                p.textAlign ||
                { low: 'left', middle: 'center', high: 'right' }[p.align],
            })
            .css(p.style)
            .add(a.axisGroup)),
            (a.axisTitle.isNew = !0)
    ...
    getTitlePosition: function () {
      var a = this.horiz,
        ...
        d = { low: f + (a ? 0 : d), middle: f + d / 2, high: f + (a ? d : 0) }[
          e.align
        ],
        b =
          (a ? c + this.height : b) +
      ...
      if (A || f)
        if (
          ...
          g.length &&
            ...
            q &&
              a.min === 0 &&
              (j[-1] || (j[-1] = new Ma(a, -1, null, !0)), j[-1].render(-1))),
          p &&
            n(g, function (b, c) {
              if (c % 2 === 0 && b < a.max)
                l[b] || (l[b] = new vb(a)),
  ...
  xb.prototype = {
    ...
    getIndex: function (a) {
      var b = this.chart
      return b.inverted
        ? b.plotHeight + b.plotTop - a.chartY
        : a.chartX - b.plotLeft
    },
    ...
    pinchTranslateDirection: function (a, b, c, d, e, f, g) {
      ...
      b < s.min
        ? ((b = s.min), (x = !0))
        : b + p > s.max && ((b = s.max - p), (x = !0))
      x
        ? ((r -= 0.8 * (r - g[i][0])), t || (v -= 0.8 * (v - g[i][1])), c())
        : (g[i] = [r, v])
      n || ((f[i] = q - m), (f[l] = p))
      f = n ? 1 / o : o
      e[l] = p
    ...
    pinch: function (a) {
      var b = this,
        ...
        p =
          g === 1 &&
          ((b.inClass(a.target, 'highcharts-tracker') && c.runTrackerClick) ||
            c.runChartClick),
        q = {}
    ...
    drag: function (a) {
      ...
      if (this.hasDragged > 10) {
        ...
        this.selectionMarker &&
          f &&
          ((d -= m),
          this.selectionMarker.attr({ width: N(d), x: (d > 0 ? 0 : d) + m }))
        this.selectionMarker &&
          g &&
          ((d = e - p),
          this.selectionMarker.attr({ height: N(d), y: (d > 0 ? 0 : d) + p }))
  ...
  eb.prototype = {
    ...
    destroyItem: function (a) {
      var b = a.checkbox
      n(['legendItem', 'legendLine', 'legendSymbol', 'legendGroup'], function (
        b
      ) {
        a[b] && (a[b] = a[b].destroy())
      })
    ...
    renderItem: function (a) {
      ...
      d = t.getBBox()
      ;(B = a.legendItemWidth =
        e.itemWidth || g + h + d.width + l + (w ? 20 : 0)),
        (e = B)
    ...
    render: function () {
      ...
      if (l || m) {
        ...
        if (i) {
          if (g > 0 && h > 0)
            i[i.isNew ? 'attr' : 'animate'](i.crisp(null, null, null, g, h)),
              (i.isNew = !1)
        } else
          (a.box = i = c
    ...
    scroll: function (a, b) {
      ...
      if (d > 0)
        b !== w && La(b, this.chart),
          ...
          this.up
            .attr({ fill: d === 1 ? h : g })
            .css({ cursor: d === 1 ? 'default' : 'pointer' }),
  ...
  yb.prototype = {
    ...
    redraw: function (a) {
      ...
      if (h)
        for (k = j; k--; ) if (((a = c[k]), a.options.stacking)) a.isDirty = !0
      n(c, function (a) {
    ...
    layOutTitles: function () {
      ...
      if (
        b &&
        (b
          .css({ width: (e.width || f) + 'px' })
          .align(r({ y: 15 }, e), !1, 'spacingBox'),
        !e.floating && !e.verticalAlign)
      )
        (a = b.getBBox().height), a >= 18 && a <= 25 && (a = 15)
      c &&
        (c
          .css({ width: (d.width || f) + 'px' })
          .align(r({ y: a + e.margin }, d), !1, 'spacingBox'),
    ...
    getChartSize: function () {
      ...
      this.chartHeight = s(
        0,
        o(a.height, this.containerHeight > 19 ? this.containerHeight : 400)
      )
    },
    ...
    getContainer: function () {
      ...
      this.container = a = U(
        ...
        {
          className:
            'highcharts-container' + (b.className ? ' ' + b.className : ''),
          id: e,
        },
        r(
          {
    ...
    drawChartBox: function () {
      ...
      u
        ? u.animate({ width: r.width, height: r.height })
    ...
    isReadyToRender: function () {
      var a = this
      return (!Z && O == O.top && y.readyState !== 'complete') ||
        ($ && !O.canvg)
        ? ($
            ? Tb.push(function () {
                a.firstRender()
  ...
  Pa.prototype = {
    ...
    destroyElements: function () {
      for (
        var a = 'graphic,dataLabel,dataLabelUpper,group,connector,shadowGroup'.split(
            ','
          ),
          b,
          c = 6;
        ...
        if (this.graphic)
          (e = f && this.graphic.symbolName && m[a].r),
            this.graphic.attr(
              x(
                m[a],
                e ? { x: b - e, y: c - e, width: 2 * e, height: 2 * e } : {}
              )
            )
        else {
          if (a && h)
  ...
  Q.prototype = {
    ...
    getColor: function () {
      ...
      if (!e && !a.colorByPoint)
        u(b._colorIndex)
          ? (a = b._colorIndex)
          : ((b._colorIndex = d.color), (a = d.color++)),
          (e = c[a])
      this.color = e
    ...
    getSymbol: function () {
      ...
      if (!this.symbol)
        u(a._symbolIndex)
          ? (a = a._symbolIndex)
          : ((a._symbolIndex = c.symbol), (a = c.symbol++)),
          (this.symbol = d[a])
    ...
    drawLegendSymbol: function (a) {
      ...
      if (c && c.enabled)
        (b = c.radius),
          (this.legendSymbol = e = f
            .symbol(this.symbol, e / 2 - b, a - b, 2 * b, 2 * b)
            .add(g)),
          (e.isMarker = !0)
    },
      ...
      for (m = 0; m < g; m++)
        (i = h + m),
          j
            ...
            : (b[i]
                ? (k = b[i])
                : a[i] !== w && (b[i] = k = new f().init(this, a[i], d[m])),
              (l[m] = k))
      if (b && (g !== (c = b.length) || j))
        for (m = 0; m < c; m++)
          if ((m === h && !j && (m += g), b[m]))
        ...
        for (o = 0; o < d; o++) {
          ...
          e === 'percent'
            ? ((p = p ? h : i),
              j && l[p] && l[p][n]
                ? ((p = l[p][n]),
                  (q.total = p.total = s(p.total, q.total) + N(t) || 0))
                : (q.total += N(t) || 0))
            : (q.total += t || 0)
          q.cum = (q.cum || 0) + (t || 0)
    ...
    translate: function () {
      ...
      for (
        ...
        l.plotY =
          typeof p === 'number' && p !== Infinity
            ? e.translate(p, 0, 1, 0, 1)
            : w
              ...
              d = b[i + 1]
                ? I(
                    s(
                      0,
                      P(
                        (e.clientX + (h ? h.wrappedClientX || h.clientX : g)) /
                          2
                      )
                    ),
                    g
    ...
    tooltipHeaderFormatter: function (a) {
      ...
      f &&
        c &&
        sa(a.key) &&
        (b = b.replace('{point.key}', '{point.key:' + c + '}'))
    ...
    animate: function (a) {
      ...
      if (a)
        ...
        if ((a = c[h]))
          a.animate({ width: c.plotSizeX }, e),
            c[h + 'm'].animate({ width: c.plotSizeX + 99 }, e)
        b.animate = null
    ...
    afterAnimate: function () {
      ...
      setTimeout(function () {
        b &&
          a[b] &&
          ((a[b] = a[b].destroy()), (a[b + 'm'] = a[b + 'm'].destroy()))
      }, 100)
    },
    drawPoints: function () {
      var a,
          ...
          if (
            ...
            if (
              ...
              k.attr({
                ...
                r(
                  { x: d - h, y: e - h },
                  k.symbolName ? { width: 2 * h, height: 2 * h } : {}
                )
              )
            else {
              if (m && (h > 0 || j))
    ...
    getAttribs: function () {
      var a = this,
        ...
        q
      b.marker
        ? ((e.radius = e.radius || c.radius + 2),
          (e.lineWidth = e.lineWidth || c.lineWidth + 1))
        : (e.color =
            e.color ||
            ra(e.color || g)
      ...
      for (g = i.length; g--; ) {
        h = i[g]
        if (
          (c = (h.options && h.options.marker) || h.options) &&
          c.enabled === !1
        )
          c.radius = 0
          ...
          c.rotation
            ...
            : (b.align(c, null, d),
              ...
              o(c.overflow, 'justify') === 'justify'
                ...
                : o(c.crop, !0) &&
                  (a =
                    f.isInsidePlot(g.x, g.y) &&
                    f.isInsidePlot(g.x + j.width, g.y + j.height)))
      a || b.attr({ y: -999 })
    },
    ...
    setVisible: function (a, b) {
      var c = this,
        ...
        h = c.visible
      f = (c.visible = a = c.userOptions.visible = a === w ? !h : a)
        ? 'show'
        : 'hide'
        ...
        f
          ...
          : (a[e] = a.chart.renderer
              ...
              .attr({
                fill: o(
                  d[2],
                  ra(d[1]).setOpacity(o(c.fillOpacity, 0.75)).get()
                ),
                zIndex: 0,
              })
              .add(a.group))
  ...
  F = ha(Q, {
    ...
    getColumnMetrics: function () {
      ...
      var c = I(
          N(c.transA) *
            (c.ordinalSlope || b.pointRange || c.closestPointRange || 1),
          c.len
        ),
        j = c * b.groupPadding,
        k = (c - 2 * j) / i,
      ...
      return (a.columnMetrics = {
        ...
        offset:
          b +
          (j +
            ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) * k -
            c / 2) *
            (e ? -1 : 1),
      })
    },
      ...
      n(this.points, function (a) {
        ...
        N(c) < f &&
          ...
          (r = t(
            N(r - e) > f
              ? b - f
              : e - (d.translate(a.y, 0, 1, 0, 1) <= e ? f : 0)
          )))
        a.barX = n
        a.pointWidth = g
        b = N(n) < 0.5
    ...
    alignDataLabel: function (a, b, c, d, e) {
      ...
      if (
        ...
        g
          ? ((d.x += i ? 0 : d.width), (d.width = 0))
          : ((d.y += i ? d.height : 0), (d.height = 0))
      c.align = o(c.align, !g || j ? 'center' : i ? 'right' : 'left')
      c.verticalAlign = o(
        c.verticalAlign,
        g || j ? 'middle' : i ? 'top' : 'bottom'
      )
  ...
  X = {
    ...
    translate: function (a) {
      ...
      var b = 0,
        ...
        i =
          (this.endAngleRad = (ya / 180) * ((c.endAngle || i + 360) - 90)) - j,
        k = this.points,
    ...
    drawDataLabels: function () {
      ...
      if (a.visible && (e.enabled || a._hasPointLabels)) {
        ...
        for (H = 0; !x && b[H]; )
          (x =
            b[H] && b[H].dataLabel && (b[H].dataLabel.getBBox().height || 21)),
            H++
        for (H = 2; H--; ) {
          var b = [],
            K = [],
