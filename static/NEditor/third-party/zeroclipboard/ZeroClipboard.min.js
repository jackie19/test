...
!(function (a) {
  ...
  var b,
    ...
    j = (function () {
      ...
      if (!document.currentScript || !(d = document.currentScript.src)) {
        ...
        if ('readyState' in f[0])
          for (
            a = f.length;
            a-- && ('interactive' !== f[a].readyState || !(d = f[a].src));
    ...
    l = function (b, c) {
      ...
      return (
        a.getComputedStyle
          ? (d = a.getComputedStyle(b, null).getPropertyValue(c))
          : ((e = k(c)), (d = b.currentStyle ? b.currentStyle[e] : b.style[e])),
        'cursor' !== c ||
        (d && 'auto' !== d) ||
        ((f = b.tagName.toLowerCase()), 'a' !== f)
          ? d
          : 'pointer'
      )
    },
    ...
    r = function () {
      var a,
        ...
        d = 1
      return (
        'function' == typeof document.body.getBoundingClientRect &&
          ((a = document.body.getBoundingClientRect()),
          (b = a.right - a.left),
          (c = document.body.offsetWidth),
          (d = Math.round((b / c) * 100) / 100)),
        d
      )
    },
    s = function (b, c) {
      ...
      if (b.getBoundingClientRect) {
        ...
        'pageXOffset' in a && 'pageYOffset' in a
          ? ((e = a.pageXOffset), (f = a.pageYOffset))
          : ((g = r()),
    ...
    u = function (b) {
      ...
      if (
        (b.trustedDomains &&
          ('string' == typeof b.trustedDomains
            ? (f = [b.trustedDomains])
            : 'object' == typeof b.trustedDomains &&
              'length' in b.trustedDomains &&
              (f = b.trustedDomains)),
        f && f.length)
      )
      ...
      return (
        h.length && (g += 'trustedOrigins=' + encodeURIComponent(h.join(','))),
        b.forceEnhancedClipboard === !0 &&
          (g += (g ? '&' : '') + 'forceEnhancedClipboard=true'),
        g
      )
    },
    v = function (a, b, c) {
      ...
      var d,
        e = b.length
      for (
        'undefined' == typeof c ? (c = 0) : 0 > c && (c = e + c), d = c;
        e > d;
        d++
      )
        ...
        a &&
          ('number' == typeof a && a > 0
            ...
            : 'string' == typeof a &&
              ...
              (b = c)),
        b ||
          ('number' == typeof O.zIndex && O.zIndex > 0
            ? (b = O.zIndex)
            : 'string' == typeof O.zIndex &&
              (c = parseInt(O.zIndex, 10)) &&
              !isNaN(c) &&
              c > 0 &&
              (b = c)),
        b || 0
    ...
    K = function () {
      ...
      function d(c) {
        c &&
          ((h = !0),
          c.version && (k = a(c.version)),
          !k && c.description && (k = a(c.description)),
          c.filename && (j = b(c.filename)))
      }
      var e,
        f,
        g,
      ...
      if (navigator.plugins && navigator.plugins.length)
        ...
        (g = navigator.mimeTypes['application/x-shockwave-flash']),
          (e = g && g.enabledPlugin),
          d(e)
      else if ('undefined' != typeof ActiveXObject) {
        i = !0
        try {
          ;(f = new ActiveXObject('ShockwaveFlash.ShockwaveFlash.7')),
            (h = !0),
            (k = a(f.GetVariable('$version')))
        } catch (l) {
          try {
  ...
  var L = function (a) {
    ...
    if (
      ((this.id = '' + f++),
      (g[this.id] = { instance: this, elements: [], handlers: {} }),
      a && this.clip(a),
      'boolean' != typeof c.ready && (c.ready = !1),
      !L.isFlashUnusable() && null === c.bridge)
    ) {
      var b = this,
      ...
      'number' == typeof d &&
        d >= 0 &&
        setTimeout(function () {
          'boolean' != typeof c.deactivated && (c.deactivated = !0),
            c.deactivated === !0 &&
              L.emit({ type: 'error', name: 'flash-deactivated', client: b })
        }, d),
        (c.overdue = !1),
        P()
    }
  ...
  var M = function (a) {
    c.ready === !0 && c.bridge && 'function' == typeof c.bridge.setHandCursor
      ? c.bridge.setHandCursor(a)
      : (c.ready = !1)
  }
  ...
  var N = function () {
    ...
    for (a = 0, b = e.length; b > a; a++)
      (c = g[e[a]].instance), c && c instanceof L && d.push(c)
    return d
  }
  ...
  ;(L.isFlashUnusable = function () {
    ...
    (L.activate = function (a) {
      b && (q(b, O.hoverClass), q(b, O.activeClass)),
        (b = a),
        p(a, O.hoverClass),
        S()
    ...
    (L.deactivate = function () {
      ...
      a &&
        ...
        (a.style.top = '-9999px'),
        T(1, 1)),
        b && (q(b, O.hoverClass), q(b, O.activeClass), (b = null))
    }),
    (L.state = function () {
      return {
        browser: F(a.navigator, ['userAgent', 'platform', 'appName']),
        flash: G(c, ['bridge']),
        zeroclipboard: { version: L.version, config: L.config() },
      }
    }),
    ...
    (L.clearData = function (a) {
      'undefined' == typeof a
        ? (D(d), (e = null))
        : 'string' == typeof a && d.hasOwnProperty(a) && delete d[a]
    })
  var P = function () {
      var b,
        d,
    ...
    R = function (a) {
      for (
        ...
        b && 'OBJECT' === b.nodeName && b.parentNode;
  ...
  L.emit = function (b) {
    ...
    if (
      ...
      if (((b = W(f, g)), Y(b), 'ready' === b.type && c.overdue === !0))
        return L.emit({ type: 'error', name: 'flash-overdue' })
      if (((h = !/^(before)?copy$/.test(b.type)), b.client))
        U.call(b.client, b, h)
      else
        for (
          i =
            b.target && b.target !== a && O.autoActivate === !0
              ? Z(b.target)
              : N(),
            j = 0,
            k = i.length;
          ...
          (l = z({}, b, { client: i[j] })), U.call(i[j], l, h)
      return (
        'copy' === b.type && ((n = H(d)), (m = n.data), (e = n.formatMap)), m
      )
    }
  }
  var U = function (b, c) {
      ...
      if (d && d.length) {
        ...
        for (e = 0, f = d.length; f > e; e++)
          (h = d[e]),
            (i = j),
            'string' == typeof h && 'function' == typeof a[h] && (h = a[h]),
            'object' == typeof h &&
              h &&
              'function' == typeof h.handleEvent &&
              ((i = h), (h = h.handleEvent)),
            'function' == typeof h && x(h, i, [b], c)
      }
      return this
    },
    V = {
    ...
    W = function (a, d) {
      if (a || (d && d.type)) {
        ;(d = d || {}),
          (a = (a || d.type).toLowerCase()),
          z(d, {
            type: a,
            target: d.target || b || null,
            relatedTarget: d.relatedTarget || null,
            currentTarget: (c && c.bridge) || null,
          })
        var f = V[d.type]
        return (
          ...
          'error' === d.type &&
            ((d.target = null),
            /^flash-(outdated|unavailable|deactivated|overdue)$/.test(d.name) &&
              z(d, { version: c.version, minimumVersion: '11.0.0' })),
          'copy' === d.type &&
            (d.clipboardData = { setData: L.setData, clearData: L.clearData }),
    ...
    Y = function (a) {
      ...
      switch (a.type) {
        ...
        case 'copy':
          ...
          !d['text/plain'] &&
          i &&
          (h = i.value || i.outerHTML || i.innerHTML) &&
          (g = i.value || i.textContent || i.innerText)
            ? (a.clipboardData.clearData(),
              a.clipboardData.setData('text/plain', g),
              h !== g && a.clipboardData.setData('text/html', h))
            : !d['text/plain'] &&
              a.target &&
              (g = a.target.getAttribute('data-clipboard-text')) &&
              (a.clipboardData.clearData(),
              a.clipboardData.setData('text/plain', g))
          break
        case 'aftercopy':
  ...
  ;(L.prototype.on = function (a, b) {
    ...
    if (f && f.length) {
      for (d = 0, e = f.length; e > d; d++)
        (a = f[d].replace(/^on/, '')),
          ...
          i[a].push(b)
      if (
        (h.ready && c.ready && L.emit({ type: 'ready', client: this }), h.error)
      ) {
        var j = [
          'disabled',
          'outdated',
    ...
    (L.prototype.off = function (a, b) {
      ...
      if (f && f.length)
        for (c = 0, d = f.length; d > c; c++)
          if (
            ((a = f[c].toLowerCase().replace(/^on/, '')),
            (h = i[a]),
            h && h.length)
          )
            if (b)
              for (e = v(b, h); -1 !== e; ) h.splice(e, 1), (e = v(b, h, e))
            else i[a].length = 0
      return this
    }),
    ...
    (L.prototype.clip = function (a) {
      ...
      for (var b = 0; b < a.length; b++)
        if (a.hasOwnProperty(b) && a[b] && 1 === a[b].nodeType) {
          a[b].zcClippingId
            ? -1 === v(this.id, i[a[b].zcClippingId]) &&
              i[a[b].zcClippingId].push(this.id)
            : ((a[b].zcClippingId = 'zcClippingId_' + h++),
              (i[a[b].zcClippingId] = [this.id]),
              O.autoActivate === !0 && n(a[b], 'mouseover', m))
      ...
      for (var e = a.length; e--; )
        if (a.hasOwnProperty(e) && a[e] && 1 === a[e].nodeType) {
          ...
          if (f) {
            ...
            0 === f.length &&
              (O.autoActivate === !0 && o(a[e], 'mouseover', m),
  ...
  var Z = function (a) {
    ...
    if (
      ...
      for (d = 0, e = c.length; e > d; d++)
        (f = g[c[d]].instance), f && f instanceof L && h.push(f)
    return h
  }
